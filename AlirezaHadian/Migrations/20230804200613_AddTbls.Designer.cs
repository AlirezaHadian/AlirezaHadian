...
namespace AlirezaHadian.Migrations
{
    ...
    [Migration("20230804200613_AddTbls")]
            ...
            modelBuilder.Entity("AlirezaHadian.Models.Skill", b =>
                {
                    ...
                    b.Property<int>("SkillsCategorySkillCategoryID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SkillsCategorySkillCategoryID");
            ...
            modelBuilder.Entity("AlirezaHadian.Models.Skill", b =>
                {
                    b.HasOne("AlirezaHadian.Models.SkillsCategory", "SkillsCategory")
                        .WithMany("Skills")
                        .HasForeignKey("SkillsCategorySkillCategoryID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
